...
int main(u64 arg1, u64 arg2, u64 arg3, u64 arg4, u64 arg5)
{
  ...
  // Hint address is already mapped.  
  // Start scanning for free slot from beginning
  char *mm3  = mmap(mm2, pages,PROT_READ, 0);
  //printf("mm3: %x, (mm1+(pages*2)): %x\n", mm3, (mm1+(pages*2)));
  if((mm3 <= 0) || (mm3 != (mm1+(pages*2))))
  {
    // Testcase failed
    printf("Test case failed \n");
    return 0;
